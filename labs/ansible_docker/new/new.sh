...
then
        ...
        do
                ...
                then
                        ...
                        sleep 3
                        docker run --name centosnode$i  --hostname  centos$i -itd --network $net_name1  --ip 192.168.100.$i  --restart=always  --privileged mdhack/ansible:main
                        docker run --name fedoranode$i -itd --network $net_name2 --hostname fedora$i  --ip 192.168.101.$i --restart=always --privileged      mdhack/fedora:main
                        # maintaining ip
