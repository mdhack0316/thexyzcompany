...
then
        ...
        do
                ...
                then
                        ...
                        sleep 0.58
                        docker run --name centosnode$i  --hostname ey$i -itd --network $net_name1  --ip 192.168.100.$i --privileged mdhack/centosansible
                        docker run --name fedoranode$i -itd --network $net_name2 --hostname ansibleey$i  --ip 192.168.101.$i --privileged mdhack/centosansible
                        # maintaining ip
